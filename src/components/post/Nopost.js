        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <defs>
            ...
            >
              {" "}
              <stop
                style={{ stopColor: "#301D00", stopOpacity: 1 }}
                offset="0.2"
              />{" "}
              <stop
          ...
          <path
            style={{ fill: "#eee", stroke: "#999", strokeWidth: 1 }}
            d="M 2,23 77,6 94,75 18,94 z"
          />{" "}
          <path
            style={{ fill: "url(#Gradient1)", stroke: "#444", strokeWidth: 1 }}
            d="M 8,27 73,12 88,71 22,88 z"
          />{" "}
          <path
            style={{ fill: "#eee", stroke: "#999", strokeWidth: 1 }}
            d="m 19,12 77,0 0,74 -77,0 z"
          />{" "}
          <path
            style={{ fill: "url(#Gradient2)", stroke: "#444" }}
            d="m 25,18 65,0 0,62 -65,0 z"
          />{" "}
          <path
